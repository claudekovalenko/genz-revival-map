...
const findings: Finding[] = [
  ...
  },
  {
    ...
    evidence:
      "This map now has five No Place Left / DMM-affiliated entries — MetaCamp (Dadeville, AL, 2012), e3 Partners (Plano, TX, 2012), a Jacksonville, FL chapter via First Coast United (2024), an NPL Houston training hub (TX, 2024), and an unverified New Braunfels, TX Facebook page (2026). Organic outbreaks, by contrast, happened in KY (four separate campuses: Asbury, Cumberlands, Campbellsville, plus the 2026 lead), OH, AL, TN (Lee and now Belmont), TX, LA, VA, IN, and UT. Only two states — AL and TX — appear on both lists, and even there it's the same coincidence noted before: no article connects MetaCamp to Samford or Auburn, and no source connects e3 Partners, NPL Houston, or New Braunfels to the Texas A&M or Waco entries. Florida has an NPL chapter but zero organic entries on this map; Kentucky (four organic entries, zero NPL chapters), Ohio, Tennessee, Louisiana, Virginia, Indiana, and Utah have organic entries but no documented NPL presence.",
    soWhat:
      "If NPL infrastructure caused organic revival, its presence should predict where outbreaks happen — it doesn't. Kentucky has the single densest cluster of organic events on this entire map and zero sourced NPL chapters; seven of nine organic-outbreak states have no NPL presence at all. Read this as evidence the two phenomena are largely independent tracks — steady disciple-making infrastructure in one set of places, unplanned spiritual spikes in a different, barely-overlapping set — not as NPL either causing or failing to cause revival. Someone closer to either network could still check for undocumented links; nothing sourced here confirms one.",
  },
  {
    ...
    <div className="max-w-3xl mx-auto px-4 py-8 flex flex-col gap-8">
      ...
      <div className="bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-xl p-5">
        ...
        <p className="text-sm leading-relaxed text-black/70 dark:text-white/60">
          This is 54 curated, press-covered events and a handful of national surveys — not a controlled study.
